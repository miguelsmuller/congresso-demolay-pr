...
wp plugin install https://github.com/Automattic/camptix/archive/refs/tags/1.6.0.zip --version=1.6.0 --force --activate --allow-root
wp plugin install camptix-pagseguro --version=1.5.5 --force --activate --allow-root
wp plugin install https://github.com/metarheinmain/camptix-payment-banktransfer/archive/master.zip --force --force --activate --allow-root
wp plugin install contact-form-7 --version=4.2 --force --allow-root
# wp plugin install kraken-image-optimizer
# wp plugin install wordpress-seo
wp plugin install wp-clean-up --version=1.2.3 --force --activate --allow-root
